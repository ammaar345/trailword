...
export default function SettingsDialog({
  ...
  return (
    <div className="animate-backdrop-in fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div
        ref={ref}
        role="dialog"
        aria-modal="true"
        ...
        tabIndex={-1}
        className="animate-dialog-in max-h-[85dvh] w-full max-w-sm overflow-y-auto rounded-2xl border border-surface-200 dark:border-surface-800 bg-white dark:bg-surface-900 p-6 shadow-2xl outline-none"
      >
